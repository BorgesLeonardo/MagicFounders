...
describe('Delete Project API', () => {
    ...
    beforeAll(async () => {
        ...
        // Cria um usuário para testes de deleção de projeto
        const user = new User({
            name: 'Project User',
        ...
        // Cria outro usuário para testar a permissão de deleção
    ...
    const createProject = async (userId) => {
        const project = new Project({
            ...
            author: 'Project User',
            chavePix: '1234567890',
            creator: userId // Adicionando o campo creator
        });
        await project.save();
        return project._id;
    };
    ...
    describe('DELETE /api/projects/:id', () => {
        ...
        it('should not delete a project if the user is not the creator', async () => {
            ...
            expect(res.statusCode).toEqual(401);  // Esperado 401 para permissão negada
